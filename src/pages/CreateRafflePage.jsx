  ...
  return (
    <div style={{ maxWidth: 1200, margin: '0 auto', padding: '40px 24px 80px' }}>
      ...
      <div style={{
        ...
        <button
          onClick={() => setRaffleCategory('crypto')}
          style={{
        ...
        {isAdmin && (
          <button
            onClick={() => setRaffleCategory('avalanche')}
            style={{
              padding: '10px 24px', borderRadius: 8, border: 'none',
          ...
          <div style={{ display: 'flex', flexDirection: 'column', gap: 20 }}>
            ...
            {isTokenPrize ? (
              ...
              <>
                {/* NFT — Image upload */}
                <div>
                  <label style={labelStyle}>NFT image <span style={{ color: 'var(--avax-red)' }}>*</span></label>
                  <div
                  ...
                  >
                    {imagePreview ? (
                      ...
                      <div style={{ color: 'var(--text-muted)' }}>
                        ...
                        <div style={{ fontSize: 13, fontWeight: 500 }}>Click to upload NFT image</div>
            ...
            {/* Raffle image — for Avalanche raffles OR NFT community raffles it's above, for token community it's optional */}
            {isAvalanche && (
              <div>
                <label style={labelStyle}>Raffle image</label>
                <div
                  onClick={() => document.getElementById('image-upload-avax').click()}
                  style={{
                    border: '2px dashed var(--card-border)',
                    borderRadius: 12,
                    padding: imagePreview ? 0 : '32px 20px',
        ...
        <div style={{ display: 'flex', flexDirection: 'column', gap: 20 }}>
          ...
          <div style={{
            ...
            {[
              ...
              { label: 'Winner receives', value: isNftPrize ? 'NFT (100%)' : isAvalanche ? 'Prize (100%)' : 'Tokens (100%)', color: 'var(--text-primary)' },
            ].map(row => (
